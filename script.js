...
generateButton.onclick = function generatePassword(){
    const character = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOOPQRSTUVWXYZ0123456789!@#$%^&*_";
    const pwdLength = 16;
    let password = "";
...
copyButton.onclick = function copyPwd(){
    ...
    if(passwordValue.trim() === ""){
        alert("Password is empy. Generate a password first");
    }
        ...
        navigator.clipboard.writeText(passwordValue).then(function(){
            ...
            setTimeout(()=> show.classList.remove("active"), 2000);
            passwordInput.value = "";
        });
    }
